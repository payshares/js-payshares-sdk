...
export class AccountCallBuilder extends CallBuilder {
     ...
     * @see [All Accounts](https://www.payshares.org/developers/horizon/reference/accounts-all.html)
     * @constructor
     * @extends CallBuilder
     ...
     *
     * @see [Account Details](https://www.payshares.org/developers/horizon/reference/accounts-single.html)
