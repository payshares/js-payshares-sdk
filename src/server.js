...
import {xdr} from "payshares-base";
...
/**
 * Server handles the network connection to a [Horizon](https://www.payshares.org/developers/horizon/learn/index.html)
 * instance and exposes an interface for requests to that instance.
 * @constructor
 * @param {string} serverURL Horizon Server URL (ex. `https://horizon-testnet.payshares.org`).
 * @param {object} [opts]
...
export class Server {
     ...
     * @see [Post Transaction](https://www.payshares.org/developers/horizon/reference/transactions-create.html)
    ...
    /**
     * People on the Payshares network can make offers to buy or sell assets. This endpoint represents all the offers a particular account makes.
    ...
    /**
     * The Payshares Network allows payments to be made between assets through path payments. A path payment specifies a
