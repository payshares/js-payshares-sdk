...
export class OperationCallBuilder extends CallBuilder {
     ...
     * @see [All Operations](https://www.payshares.org/developers/horizon/reference/operations-all.html)
     * @constructor
     * @extends CallBuilder
     ...
     * @see [Operation Details](https://www.payshares.org/developers/horizon/reference/operations-single.html)
     ...
     * @see [Operations for Account](https://www.payshares.org/developers/horizon/reference/operations-for-account.html)
     ...
     *
     * @see [Operations for Ledger](https://www.payshares.org/developers/horizon/reference/operations-for-ledger.html)
     ...
     * @see [Operations for Transaction](https://www.payshares.org/developers/horizon/reference/operations-for-transaction.html)
