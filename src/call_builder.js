...
export class CallBuilder {
   ...
   * @see [Horizon Response Format](https://www.payshares.org/developers/horizon/learn/responses.html)
  ...
  _sendNormalRequest(url) {
    ...
    // Temp fix for: https://github.com/payshares/js-payshares-sdk/issues/15
   ...
   * @see [Paging](https://www.payshares.org/developers/horizon/learn/paging.html)
