...
export class EffectCallBuilder extends CallBuilder {
     ...
     * @see [All Effects](https://www.payshares.org/developers/horizon/reference/effects-all.html)
     * @constructor
     ...
     * @see [Effects for Account](https://www.payshares.org/developers/horizon/reference/effects-for-account.html)
     ...
     * @see [Effects for Ledger](https://www.payshares.org/developers/horizon/reference/effects-for-ledger.html)
     ...
     * @see [Effects for Transaction](https://www.payshares.org/developers/horizon/reference/effects-for-transaction.html)
     ...
     * @see [Effects for Operation](https://www.payshares.org/developers/horizon/reference/effects-for-operation.html)
